      ...
      <?php  if(defined('IN_SOLUTION')) { ?>
			...
			<?php  } else { ?>
			   <ul class="nav navbar-nav hidden-xs">
				...
				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('platform', $_W['setting']['permurls']['sections'])) { ?><li class="dropdown <?php  if(FRAME == 'platform') { ?>dker<?php  } ?>"><a href="<?php  echo url('home/welcome/platform');?>"><i class="fa fa-cog"></i> 基础设置</a></li><?php  } ?>
				
				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('platform', $_W['setting']['permurls']['sections'])) { ?><li class="dropdown <?php  if(FRAME == 'ext') { ?>dker<?php  } ?>"><a href="<?php  echo url('home/welcome/ext');?>"><i class="fa fa-cubes"></i> 分销管理</a></li><?php  } ?>
				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('platform', $_W['setting']['permurls']['sections'])) { ?><li class="dropdown <?php  if(FRAME == 'setting') { ?>dker<?php  } ?>"><a href="<?php  echo url('home/welcome/setting');?>"><i class="fa fa-umbrella"></i> 支付设置</a></li><?php  } ?>
				
					<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('platform', $_W['setting']['permurls']['sections'])) { ?><li class="dropdown <?php  if(FRAME == 'mc') { ?>dker<?php  } ?>"><a href="<?php  echo url('home/welcome/mc');?>"><i class="fa fa-gift"></i> 粉丝营销</a></li><?php  } ?>
				
				<?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('platform', $_W['setting']['permurls']['sections'])) { ?><li class="dropdown <?php  if(FRAME == 'site') { ?>dker<?php  } ?>"><a href="<?php  echo url('home/welcome/site');?>"><i class="fa fa-life-bouy"></i> 微站功能</a></li><?php  } ?>
			     
				
				
				<?php  if(FRAME == 'solution') { ?><li class="dropdown dker"><a href="<?php  echo url('home/welcome/solution', array('m' => $m));?>"><i class="fa fa-comments"></i> 行业功能 - <?php  echo $solution['title'];?></a></li><?php  } ?>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
				<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-group"></i> <b class="caret"></b></a>
				<!--
				...
				<li class="dropdown">
				<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <b class="caret"></b></a>
				<!--
    ...
    <section class="hbox stretch"> <!-- .aside -->
      <aside class="bg-light lter aside-md hidden-print b-r" id="nav"  style="width:219px;">
		...
		<li class="<?php  echo $link['active'];?>"> <a  href="<?php  echo $link['url'];?>" class='pull-left' style='display: block;width:190px'><i class="fa fa-angle-right"></i> <span><?php  echo $link['title'];?></span></a>
                    <a href='<?php  echo $link['append']['url'];?>' class="pull-left" style='display:block;width:28px;height:43px;padding:5px;padding-right:10px;padding-top:10px;'><?php  echo $link['append']['title'];?></a>
