...
<link rel="stylesheet" href="<?php echo RES_URL;?>css/login.css" type="text/css" />--><link rel="stylesheet" href="<?php echo RES_URL;?>css/login-default.css" type="text/css" /><link rel="stylesheet" href="<?php echo RES_URL;?>css/form-element.css" type="text/css" />
<?php $logo = !empty($_W['setting']['copyright']['flogo'])?tomedia($_W['setting']['copyright']['flogo']):'./themes/hc_style1/style/images/gw-logo.png'?>   <div class="top-content" style="margin-bottom: 10em">       	            <div class="inner-bg">                <div class="container">                    <div class="row form-box">                        <div class="col-sm-8 col-sm-offset-2 text">                            <h1><strong>Miwo</strong>Wechat</h1>                            <div class="description">                            	<p>	                            	The man who has made up his mind to win will never say "Impossible".                            	</p>                            </div>                        </div>                    </div>                				<div class="row">                        <div class="col-sm-6 col-sm-offset-3 form-box">                        	<div class="form-top">                        		<div class="form-top-left">                        			<h3>微信公众号</h3>                            		<p>自主管理平台</p>                        		</div>                        		<div class="form-top-right">                        			<i class="fa fa-key"></i>                        		</div>                            </div>                            <div class="form-bottom">			                    <form role="form" id="login_form"  method="post" class="login-form" onsubmit="return formcheck();">			                    	<div class="form-group">			                    		<label class="sr-only" for="form-username">Username</label>			                        	<input type="text" name="username" placeholder="请输入用户名" class="form-username form-control" id="whz-login-user-name">			                        </div>			                        <div class="form-group">			                        	<label class="sr-only" for="form-password">Password</label>			                        	<input type="password" name="password" placeholder="请输入密码" class="password form-control" id="whz-login-user-password">			                        </div>									<!--									<div class="form-group">									<label>									<input type="checkbox" value="true" name="rember" id="remember"> 记住用户名									</label>									</div>									-->									<input name="token" value="<?php  echo $_W['token'];?>" type="hidden" />			                         <input type="submit" name="submit" value="登录" class="btn btn-block btn-success">									 			                    </form>		                    </div>                        </div>                    </div>                </div>            </div>        </div><div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 100%; width: 1423px; z-index: -999999; position: fixed;"><img src="<?php echo RES_URL;?>images/1.jpg" style="position: absolute; margin: 0px; padding: 0px; border: none; width: 1423px; max-height: 1500px; max-width: none; z-index: -999999; left: 0px; top: 0;"></div><!--
