				...
				if ($paytype == 'refuse') {
					...
					if ($paytype == 'refund') {
						...
						if ($log['rechargetype'] == 'wechat') {
							$result = m('finance')->refund($log['openid'], $log['logno'], $out_refund_no, $log['money'] * 100);
						} else {
